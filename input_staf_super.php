        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Input Data Akun</h1>

                    <form autocomplete="off" required="" method="POST" action="input_staf_super_action.php">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="exampleInputUsername" placeholder="Masukkan Username" required="" name="username">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword" class="input">Password</label>
                                <input type="password" class="form-control input" id="exampleInputPassword" placeholder="Masukkan Password" required="" name="password">
                            </div>
                        </div>
                        <!-- /.card-body -->
