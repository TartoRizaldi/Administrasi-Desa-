        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        if(isset($_GET['input'])){
                            if($_GET['input'] == "ready"){
                                ...
                                echo "
                                    ...
                                    <div class='alert alert-danger alert-dismissible div4'>
                                        <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                        <strong>Data kurang lengkap (Jenis Kelamin atau Agama belum dipilih)</strong>
                                    </div>
                                    <center>
                                ";
                            }
                    ...
                    <form autocomplete="off" required="" method="POST" action="input_data_penduduk_super_action.php">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputNik" class="input">NIK</label>
                                <input type="number" min="0" class="form-control input" id="exampleInputNIK" placeholder="Masukkan NIK" required="" name="nik">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input" id="sel1" name="jenis" id="exampleInputJenis">
                                    ...
                                    <option required="">Laki-laki</option>
                                    <option required="">Perempuan</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control input" id="exampleInputTanggal" placeholder="Masukkan Tanggal Lahir" required="" name="tanggal">
                            </div>
                            <div class="form-group">
