<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($nik == $nik2) {
            header("location: input_data_penduduk_super.php?input=ready");
        }
        else if ($jenis == "") {
            header("location: input_data_penduduk_super.php?input=error");
        }
        else if ($agama == "") {
            header("location: input_data_penduduk_super.php?input=error");
        }
            ...
            header("location: input_data_penduduk_super.php?input=ready");
                ...
                header("location: view_data_penduduk_super.php?input=success");
            }
        }
    }
?>