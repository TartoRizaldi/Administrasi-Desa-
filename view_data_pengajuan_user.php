<?php
    ...
    $result1 = mysqli_query($conn, "SELECT * FROM data_pengajuan_surat WHERE nik = '$username'");
                      ...
                      <td>
                          <center>
                            <?php
                                ...
                                if ($data['status'] == "ACC" AND $data['kategori'] == "Surat Domisili") {
                                    ?>
                                        <a href="<?php echo "cetak_domisili_user.php?id_data=".$data['id_data']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Cetak" target="blank">
                                            <i class="fas fa-print"></i>
                                        </a>
                                    <?php
                                }
                                else if ($data['status'] == "ACC" AND $data['kategori'] == "Surat Tidak Mampu") {
                                    ?>
                                        <a href="<?php echo "cetak_tidak_mampu_user.php?id_data=".$data['id_data']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Cetak" target="blank">
                                            <i class="fas fa-print"></i>
                                        </a>
                                    <?php
                                }
                                else if ($data['status'] == "ACC" AND $data['kategori'] == "Surat Usaha") {
                                    ?>
                                        <a href="<?php echo "cetak_usaha_user.php?id_data=".$data['id_data']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Cetak" target="blank">
                                            <i class="fas fa-print"></i>
                                        </a>
                                    <?php
                                }
                                else if ($data['status'] == "ACC" AND $data['kategori'] == "Surat Pindah") {
                                    ?>
                                        <a href="<?php echo "cetak_pindah_user.php?id_data=".$data['id_data']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Cetak" target="blank">
                                            <i class="fas fa-print"></i>
                                        </a>
                                    <?php
                                }
