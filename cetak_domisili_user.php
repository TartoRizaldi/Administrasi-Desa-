<?php
    ...
    <body>
        <div id=halaman>
            ...
            <br>
            <p  class="para">Berdasarkan pengamatan Kami, yang bersangkutan benar-benar penduduk yang berdomisili di Desa Konut Kecamatan Tanah Siang, Kabupaten Murung Raya Provinsi Kalimantan Tengah dan terdaftar dalam register kependudukan Kami.</p>
