<?php
    ...
    $dataUbah = mysqli_query($conn, "SELECT * FROM akun WHERE id_akun='$id_akun'");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="input_staf_super.php">Input</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Update Data Akun</h1>

                    <form autocomplete="off" required="" method="POST" action="<?php echo "update_staf_super_action.php?id_akun=".$data['id_akun']; ?>">
                        <div class="card-body">
                            <br>
                            <div class="form-group">
                                <label for="exampleInputNama" class="input">Nama</label>
                                <input type="text" class="form-control input" id="exampleInputNama" required="" name="nama" value="<?php echo $data['nama_akun']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername" class="input">Username</label>
                                <input type="text" class="form-control input" id="exampleInputUsername" required="" name="username" value="<?php echo $data['username_akun']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword" class="input">Password</label>
                                <input type="text" class="form-control input" id="exampleInputPassword" required="" name="password" value="<?php echo $data['password_akun']; ?>">
                            </div>
                        </div>
                        <!-- /.card-body -->
