            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="view_staf_super.php">View</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">View Data Akun</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    $result= mysqli_query($conn, "SELECT * FROM akun WHERE id_akses = 2");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <a href="<?php echo "update_staf_super.php?id_akun=".$data['id_akun']; ?>" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" title="Edit">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="<?php echo "delete_staf_super_action.php?id_akun=".$data['id_akun']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">
