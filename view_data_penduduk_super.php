        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card-header">
                    <div class="input_down">
                        <a href="input_data_penduduk_super.php" class="btn btn-info tombol" role="button">Tambah Data</a>
                    </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                            <a href="<?php echo "update_data_penduduk_super.php?nik=".$data['nik']; ?>" class="btn btn-info btn-circle btn-sm" data-toggle="tooltip" title="Edit">
                                <i class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="<?php echo "delete_data_penduduk_super_action.php?nik=".$data['nik']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">
