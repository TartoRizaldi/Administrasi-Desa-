<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $result2= mysqli_query($conn, "SELECT id_akun FROM akun WHERE username_akun='$username'");
        ...
        if ($username == $ha AND $id_akun != $ha2) {
            ...
            $simpanData = mysqli_query($conn, "UPDATE akun SET nama_akun='$nama',username_akun='$username',password_akun='$password',id_akses='$akses' WHERE id_akun='$id_akun'");
