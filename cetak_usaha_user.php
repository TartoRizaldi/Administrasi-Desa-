<?php
    ...
    <body>
        <div id=halaman>
            ...
            <br>
           <p  class="para">Bahwa nama tersebut di atas, adalah benar penduduk yang berdomisili di Desa Konut Kecamatan Tanah Siang, dan yang bersangkutan mempunyai suatu usaha. Usaha tersebut sampai saat ini tetap berjalan lancar.</p>
