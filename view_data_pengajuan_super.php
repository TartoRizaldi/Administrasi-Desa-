                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <center>
                            <a href="<?php echo "detail_data_pengajuan_super.php?id_data=".$data['id_data']; ?>" class="btn btn-warning btn-circle btn-sm" data-toggle="tooltip" title="Detail">
                                <i class="fas fa-info"></i>
                            </a>
                            <a href="<?php echo "delete_data_pengajuan_super_action.php?id_data=".$data['id_data']; ?>" class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" title="Delete">
